...
#+Time-stamp: <2019-05-10 11:52:23 richard>
...
#+END_SRC
*** Code Block Indentation Function.

While it is nice to be able to embed the code in these little blocks
and then surround them with some useful prose, without this code block
the code formatting isn't great. This hasn't been an issue so far, as
Lisp isn't particularly sensitive to things like code layout and
indentation, but it could have become more problematic when dealing
with other languages, especially Python.
